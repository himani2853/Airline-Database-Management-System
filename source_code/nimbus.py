...
Original file is located at
    https://colab.research.google.com/drive/1YQq6Uy3jI9AWGs-WP3t0wdc3wg4g7Ppz
"""
...
def InsertAirport():
    try:
        ...
        row["Airport_Code"] = input("Flight Number: ")
        ...
        if row["City"] not in cities_list:
            query = "INSERT INTO Address(City, State,Country) VALUES('%s')" % (row["City"])
            cur.execute(query)
            con.commit()
...
def Search():
    ...
    print("1. Search for Aircrafts purchased after a particular year")
